...
*/
const T.ilyasa = 'Tsukasa'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/Tegarilyasa'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6287881008758'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/BeUv2Z9bOPGHHF4yQKm0tF'; // JANGAN UBAH-UBAH INFO!!!
...
conn.sendMessage(id, ' _3aalaikumsalam, _Iyah aku disini master...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, ' _Waalaikumsalam, Iyah aku disini master...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa saya bantu? Ketik *#menu* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'P'){
